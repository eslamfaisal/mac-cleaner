...
function walkTask(task) {
  ...
  const { maxDepth, fanoutDepth, claimed, rules, prefixRules, largeFileMin, binaryExts, binaryMin, installerExts, installerMin, downloadsDir, home, dupMin, packageSkips } = config;
