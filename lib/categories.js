...
export const NORMAL_GROUPS = [
  ...
  { id: 'n-large', title: 'Large & Old Files', icon: '🐋',
    desc: 'The biggest files on your Mac, and the ones you have not opened in a long time.' },
...
export function buildStaticTargets() {
  ...
  return [
    ...
    T('creative', 'Lightroom previews', h('Pictures/Lightroom'), 'caution',
      'Lightroom catalog folder — the *Previews.lrdata bundles inside are generated JPEG previews, often tens of GB.',
      'Lightroom regenerates previews from the originals; the catalog itself must be kept.',
      { kind: 'children' }),
