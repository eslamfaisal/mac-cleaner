...
export function buildStaticTargets() {
  ...
  return [
    ...
    T('ide', 'JetBrains caches', h('Library/Caches/JetBrains'), 'safe',
      'IDE caches and indexes, one per product/version.',
      'Rebuilt on next IDE start (first open slower).',
      { kind: 'children' }),
    T('ide', 'Android Studio caches', h('Library/Caches/Google'), 'safe',
      'Android Studio / Google IDE caches and Chrome cache (split per product).',
      'Rebuilt automatically.',
      { kind: 'children', crossRef: 'as-version' }),
    ...
    T('apps', 'Spotify cache', path.join(AS, 'Spotify/PersistentCache'), 'safe',
      'Streaming cache.', 'Re-cached while listening.'),
...
export const ARTIFACT_RULES = [
  ...
  { dir: 'target', siblings: ['Cargo.toml', 'pom.xml'], safety: 'safe', why: 'Rust/Maven build output.', regen: 'Regenerated by next build.' },
