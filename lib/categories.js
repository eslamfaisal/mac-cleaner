...
export const NORMAL_GROUPS = [
  ...
  { id: 'n-mail', title: 'Mail & Message Attachments', icon: '📎',
    desc: 'Copies of attachments from Mail and Messages. The originals stay in your conversations.' },
...
export function buildStaticTargets() {
  ...
  return [
    ...
    T('apps', 'OneDrive cache', h('Library/Caches/com.microsoft.OneDrive'), 'safe',
      'OneDrive sync cache.', 'Rebuilt while syncing.'),
    T('apps', 'iCloud Drive local copies', h('Library/Application Support/CloudDocs'), 'caution',
      'Local copies and sync state of iCloud Drive documents (root of the "iCloud Drive" storage bucket).',
      'macOS re-downloads files from iCloud on demand. Anything not yet uploaded would be lost.',
      { displayOnly: true }),
